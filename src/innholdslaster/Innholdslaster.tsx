...
const harStatus = (...status: STATUS[]) => (element: Avhengighet<unknown>) =>
...
const medFeil = (avhengigheter: Avhengighet<unknown>[]) =>
  avhengigheter.filter(harStatus(STATUS.ERROR));
...
function Innholdslaster(props: Props) {
  ...
  console.log(
    "Innholdslaster",
    props.avhengigheter,
    alleLastet(props.avhengigheter)
  );
