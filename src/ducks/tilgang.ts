...
type InnsendingKommunaleSjekkOk = Action<
  TypeKeys.INNSENDING_KOMMUNALE_SJEKK_OK
> &
  DucksData<TilgangsDTO>;
type InnsendingKommunaleSjekkPending = Action<
  TypeKeys.INNSENDING_KOMMUNALE_SJEKK_PENDING
>;
type InnsendingKommunaleSjekkFeilet = Action<
  TypeKeys.INNSENDING_KOMMUNALE_SJEKK_FEILET
> &
  DucksData<Error>;

type Actions =
  | InnsendingKommunaleSjekkOk
  | InnsendingKommunaleSjekkPending
  | InnsendingKommunaleSjekkFeilet;

interface OkState extends AvhengigheterOkState<TilgangsDTO> {}
