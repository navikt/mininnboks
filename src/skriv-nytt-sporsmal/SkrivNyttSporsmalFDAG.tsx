            ...
            <article className="blokk-center send-sporsmal-side skriv-nytt-sporsmal">
                ...
                <form className="panel" onSubmit={state.onSubmit(submitHandler)}>
                    ...
                    <AlertstripeVisibleIf type="advarsel" visibleIf={!rateLimiter}>
                        Du har oversteget antall meldinger som kan sendes til NAV på kort tid. Prøv igjen på ett senere tidspunkt.
                    ...
                    <AlertStripeInfoSolid className="blokk-xs">
                        ...
                        <Lenke href="skriv.ny.link" className="Lenke"> Skriv til Oss</Lenke>
                    ...
                    <Normaltekst className="typo-normal blokk-xs">
                        ...
                        <Lenke href="https://www.nav.no/dagpenger/forskudd/oversikt" className="Lenke">endrer nedbetalingsplanen</Lenke> der.
                    </Normaltekst>
                    <Normaltekst className="typo-normal blokk-xs">
                        Du kan også
                        <Lenke href="https://www.nav.no/no/person/innhold-til-person-forside/nyttig-a-vite/kampanje-korona/tilbakebetaling-og-trekk-av-forskudd-pa-dagpenger" className="Lenke">lese om tilbakebetaling av forskudd.</Lenke>
                    </Normaltekst>
                    <Textarea
                    ...
                    <div className="text-center">
                        ...
                        />
                        <Hovedknapp spinner={props.sendingStatus === STATUS.PENDING} aria-disabled={props.sendingStatus === STATUS.PENDING}>
                           Send
                        </Hovedknapp>
                    </div>
                </form>
