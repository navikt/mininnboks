...
fetchMock.get("/mininnboks-api/tilgang/oksos", (req, res, ctx) =>
  res(
    ctx.json({ resultat: "OK", melding: "Kunne ikke hente data fra pdl-api" })
  )
);
...
fetchMock.post("/mininnboks-api/traader/svar", (req, res, ctx) =>
  res(ctx.json({}))
);
fetchMock.post("/mininnboks-api/traader/sporsmal", (req, res, ctx) =>
  res(ctx.json({}))
);
fetchMock.post("/mininnboks-api/traader/lest/:id", (req, res, ctx) =>
  res(ctx.json({}))
);
fetchMock.post("/mininnboks-api/traader/allelest/:id", (req, res, ctx) =>
  res(ctx.json({}))
);
