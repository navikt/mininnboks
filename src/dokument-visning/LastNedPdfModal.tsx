...
function LastNedPdfModal() {
  ...
  return (
    ...
    >
      <Alertstripe
        type="info"
        className="mininnboks-modal side-innhold last-ned-pdf-modal"
      >
        <div className="panel">
          <h2 className="hode hode-innholdstittel hode-dekorert hode-advarsel blokk-s">
            <span className="vekk">
              {intl.formatMessage({ id: "modal.lastnedpdf.ikon.aria" })}
            </span>
            {intl.formatMessage({ id: "modal.lastnedpdf.obs" })}
          </h2>
          <p className="blokk-s text-center">
            {intl.formatMessage({ id: "modal.lastnedpdf.tekst" })}
          </p>
