...
function AvsenderMottaker(props : Props) {
    if (props.retning === 'INN' && props.avsender === 'SLUTTBRUKER') {
        ...
        return <FormattedMessage id={'dokumentvisning.mottatt.sendt.til.eksternpart'} values={{ eksternpart: props.navn }}/>;
    } else if (props.retning === 'INN' && props.avsender === 'EKSTERN_PART') {
        return <FormattedMessage id={'dokumentvisning.mottatt.sendt.fra.eksternpart'} values={{ eksternpart: props.navn }}/>;
